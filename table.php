                                            ...
                                            foreach ($query_run as $troc) 
                                            {
                                               ...
                                               <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="troc-edit.php?idEX=<?= $troc['idEX']; ?>" class="btn btn-success btn-sm">Update</a>
                                                    
                                                    <form action="code.php" method="POST" class="d-inline">
                                                    <button type="submit" name="delete-troc" value="<?= $troc['idEX'] ?>" class="btn btn-danger btn-sm">Delete</button>
                                            ...
                                            foreach ($query_run as $argent) 
                                            {
                                               ...
                                               <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="payment-edit.php?ID=<?= $argent['ID']; ?>" class="btn btn-success btn-sm">Update</a>
                                                    
                                                    <form action="code1.php" method="POST" class="d-inline">
                                                    <button type="submit" name="delete-argent" value="<?= $argent['ID'] ?>" class="btn btn-danger btn-sm">Delete</button>
